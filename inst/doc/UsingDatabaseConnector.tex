...
\hypersetup{unicode=true,
            pdftitle={Using DatabaseConnectorr},
...
\hypertarget{obtaining-drivers-for-netezza-and-impala}{%
\section{Obtaining drivers for Netezza and
Impala}\label{obtaining-drivers-for-netezza-and-impala}}

The package already contins most drivers, but because of licensing
reasons the drivers for Netezza and Impala are not included but must be
obtained by the user. Type
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{disconect}\NormalTok{(conn)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{specifying-the-driver-location-for-netezza-and-impala}{%
\subsection{Specifying the driver location for Netezza and
Impala}\label{specifying-the-driver-location-for-netezza-and-impala}}

For Netezza and Impala the drivers are not included in the
