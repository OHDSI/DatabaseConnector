...
Note that, on some platforms like Oracle, when using temp tables, it might be required to provide a `tempEmulationSchema`, since these platforms do not support tables the way other platforms do. 
