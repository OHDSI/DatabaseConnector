...
#' 
#' @export
renderTranslateQueryApplyBatched <- function(
  connection,
  sql,
  fun,
  args = list(),
...
#' @export
renderTranslateQueryApplyBatched.default <- function(
  connection,
  sql,
  fun,
  args = list(),
...
#' @export
renderTranslateQueryApplyBatched.DatabaseConnectorDbiConnection <- function(
  connection,
  sql,
  fun,
  args = list(),
